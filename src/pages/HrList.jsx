...
const EmployeePage = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get("http://127.0.0.1:8080/api/hr/all", { withCredentials: true })
      .then((response) => {
  ...
  const handleRowClick = (hrId) => {
    navigate(`/hr-detail/${hrId}`); // Redirect to employee-detail page with employee ID
  };
